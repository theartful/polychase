...
// This currently won't work though, since embree for example only supports
// floats
using Float = float;

// Row major types

using RowMajorArrayX4f =
    Eigen::Array<Float, Eigen::Dynamic, 4, Eigen::RowMajor>;
using RowMajorArrayX3f =
    Eigen::Array<Float, Eigen::Dynamic, 3, Eigen::RowMajor>;
using RowMajorArrayX2f =
    Eigen::Array<Float, Eigen::Dynamic, 2, Eigen::RowMajor>;
using RowMajorArrayX3u =
    Eigen::Array<uint32_t, Eigen::Dynamic, 3, Eigen::RowMajor>;
using RowMajorArrayX2u =
    Eigen::Array<uint32_t, Eigen::Dynamic, 2, Eigen::RowMajor>;

using RowMajorMatrixX4f =
    Eigen::Matrix<Float, Eigen::Dynamic, 4, Eigen::RowMajor>;
using RowMajorMatrixX3f =
    Eigen::Matrix<Float, Eigen::Dynamic, 3, Eigen::RowMajor>;
using RowMajorMatrixX2f =
